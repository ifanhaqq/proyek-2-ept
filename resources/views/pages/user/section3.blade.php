...
@section('content')
    <div class="container mt-5 test-box ">
        <form action="" method="">
            <p>Questions 1–10
                <br>The Alaska pipeline starts at the frozen edge of the
                ...
                <br>The steel pipe crosses windswept
                ...
                <br>One of the largest in the world, the pipeline cost
                ...
                and is operating.</p>
            <ol>
                <li>The passage primarily discusses the pipeline's</li>
            </ol>
            <div class="options">
                <label class="btn btn-light">
                    <input type="radio" name="answer" value="A"> A. operating costs
                </label>
                <label class="btn btn-light">
                    <input type="radio" name="answer" value="B"> B. employees
                </label>
                <label class="btn btn-light">
                    <input type="radio" name="answer" value="C"> C. consumers
                </label>
                <label class="btn btn-light">
                    <input type="radio" name="answer" value="D"> D. construction
                </label>
            </div>
